...
parcelHelpers.export(exports, "ELAComponent", ()=>(0, _ela.ELAComponent));
var _ela = require("./ela");

},{"./ela":"kll3Q","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kll3Q":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "ELAComponent", ()=>ELAComponent);
var _elaScss = require("./ela.scss");
...
function ELAComponent(userConfig) {
    const config = (0, _helpers.extendConfig)(defaultConfig, userConfig);
    ...
    function onKeyDown(e) {
        const shortcut = (0, _helpers.getShortcutByEvent)(e);
        switch(shortcut){
    ...
    function onGlobalClick(event) {
        ...
        if (targetEl?.hasAttribute(TEST_ID_ATTR) || targetEl?.hasAttribute(PSEUDO_ID_ATTR)) {
            ...
            if (event.ctrlKey) {
                ...
                const parents = _jquery(targetEl).parents().filter((i, parentEl)=>parentEl.hasAttribute(TEST_ID_ATTR) || isPseudo && parentEl.hasAttribute(PSEUDO_ID_ATTR)).toArray();
                const pseudoQuery = [
                    ...parents.reverse(),
                    targetEl
    ...
    function attachPseudoAttrs() {
        for(let pseudoSelector in pseudoSelectorMap){
            ...
            _jquery(selector).each((index, el)=>{
                el.setAttribute(PSEUDO_ID_ATTR, pseudoId);
                if (rawSelector.includes("$name") && !el.hasAttribute(PSEUDO_NAME_ATTR)) setPseudoNameAttr(el, selector);
                if (!el.hasAttribute(TEST_PARAMS_ATTR)) setTestParamsAttr(el);
            });
        }
    }
    function attachParamsAttrs() {
        const elements = _jquery(`[${TEST_ID_ATTR}]`).toArray();
    ...
    function setPseudoNameAttr(el, selector) {
        ...
        switch(true){
            /* Name from Text Content */ case selector.includes(":contains()"):
                {
                    ...
                    const [targetEl] = targetSelector ? _jquery(el).find(targetSelector).toArray() : [
                        el
                    ];
            ...
            /* Name from an Attr */ case selector.includes("["):
                {
                    const foundEls = innerSelector ? _jquery(el).find(innerSelector).toArray() : [
                        el
                    ];
    ...
    function setTestParamsAttr(el) {
        ...
        if (paramsList.length) el.setAttribute(TEST_PARAMS_ATTR, `%(${paramsList.join(",")})`);
    }
...
},{"./ela.scss":"eSbJc","jquery":"hgMhh","./helpers":"hyZmv","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eSbJc":[function() {},{}],"hgMhh":[function(require,module,exports) {
/*!
...
},{}],"hyZmv":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _extendConfig = require("./extend-config");
parcelHelpers.exportAll(_extendConfig, exports);
var _getShortcutByEvent = require("./get-shortcut-by-event");
parcelHelpers.exportAll(_getShortcutByEvent, exports);

},{"./extend-config":"6oF0w","./get-shortcut-by-event":"j0h3F","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6oF0w":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "extendConfig", ()=>extendConfig);
...
},{}],"j0h3F":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getShortcutByEvent", ()=>getShortcutByEvent);
const keysMap = {
    ctrlKey: "ctrl",
    shiftKey: "shift",
    altKey: "alt"
};
function getShortcutByEvent(e) {
    const key = e.keyCode > 18 ? e.code.replace(/^Key/, "") : "";
    const specialPart = Object.entries(keysMap).reduce((result, [key, name])=>e[key] ? result.concat(name) : result, []);
    return [
        ...specialPart,
        key
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["2oZg2"], null, "parcelRequire1a84")

//# sourceMappingURL=e2e-helpers-ela.b71e74eb.js.map
